...
{
	CString strScore;
	this->m_ListCon.GetText(m_Listid, strScore);
	int len = strScore.GetLength();
	int idex = strScore.Find(_T("成"));
	CString szQueue = strScore.Right(len - idex);
	AfxMessageBox(szQueue, MB_ICONINFORMATION);
	// TODO:  在此添加控件通知处理程序代码
}
